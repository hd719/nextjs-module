...
export async function createChat(
  ...
  // The currval function returns the most recent value of a sequence for a specified table and column
  // pg_get_serial_sequence system function that returns the name of the sequence associated with a specified table and column, typically one that uses a serial or auto-incrementing type ex. chats_id_seq (table_column_seq)
